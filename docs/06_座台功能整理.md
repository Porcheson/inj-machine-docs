...
| `uiNozzleMode`  | UINT        | 0-4        | 0      | 座台模式 (0:无模式 1:座台进模式 2:座台退模式 3:座台进(调试模式) 4:座台退(调试模式)) |
...
| `dwAlarmID`  | DWORD | 0-4294967295 | 0      | 报警代码（按位标识：Bit0座台进超时 Bit1座台退超时 Bit2位置超限 Bit3传感器异常） |
